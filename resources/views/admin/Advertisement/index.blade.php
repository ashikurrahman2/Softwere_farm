        ...
        <div class="col-sm-12">
          <div class="card">
            <div class="card-header table-card-header">
              <h5>All Advertisement list here</h5>
            </div>
            <div class="card-body">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title h4" id="myLargeModalLabel">Add New Advertisement</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{route('advertisement.store')}}" method="post" id="add-form">
              @csrf
              <div class="modal-body">
                <div class="row">
                  ...
                  <div class="form-group">
                    <label for="brand_logo" class="col-form-label pt-0">Advertisement Image <sup class="text-size-20 top-1">*</sup></label>
                    <input type="file" class="dropify" data-height="200" name="image" />
                    <small id="emailHelp" class="form-text text-muted">This is your advertisement Image</small>
                  </div>
...
// For Edit Child Category
    $('body').on('click', '.edit', function() {
        let id = $(this).data('id');
        $.get("advertisement/" + id + "/edit", function(data) {
